...
int main(int argc, char* argv[]) {
  ...
  string graph_path = tensorflow::io::JoinPath(base_path, "inception.stripped.pb");
  string tensor_dir = tensorflow::io::JoinPath(base_path, "inception_tensors");
