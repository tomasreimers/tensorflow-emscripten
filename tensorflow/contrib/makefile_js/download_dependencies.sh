...
DOWNLOADS_DIR=tensorflow/contrib/makefile_js/downloads
...
git clone https://github.com/tomasreimers/protobuf-emscripten.git ${DOWNLOADS_DIR}/protobuf-emscripten
pushd ${DOWNLOADS_DIR}/protobuf-emscripten
./autogen.sh
